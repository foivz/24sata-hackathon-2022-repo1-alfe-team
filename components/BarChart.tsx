  ...
  return (
    <HStack maxW={'md'} justifyContent={'space-around'} alignItems={'end'}>
      {['Jan', 'Feb', 'Mar', 'Apr', 'May'].map((mth, i) => {
        ...
        return (
        <Stack h={'150px'} onClick={() => setSelected(i)} rounded="md" backgroundColor={selected===i?useColorModeValue('gray.100', 'gray.900'):''} w={12} justifyContent={'end'} p={2} alignItems={'center'} key={i}>
